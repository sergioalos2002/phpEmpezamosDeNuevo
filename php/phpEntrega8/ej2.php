...
<body>
    ...
    if (preg_match("/^[6||9][0-9]{9}$/",$texto)) {
        echo "<p>La cadena  (" . $texto . ") es un numero de telefono</p>";
    }else{
        echo "<p>La cadena  (" . $texto . ") No es un numero de telefono</p>";
    } 
    echo "<br> ej9";
    
    if (preg_match("/^[0-9]{8}[A-Z]?$/",$texto)) {
        echo "<p>La cadena  (" . $texto . ") es un DNI</p>";
    }else{
        echo "<p>La cadena  (" . $texto . ") No es un DNI</p>";
    } 
    echo "<br> ej10";
    if (preg_match("/^[0-4]{1}[0-9]{4}$/",$texto)) {
        echo "<p>La cadena  (" . $texto . ") es un DNI</p>";
    }else{
        echo "<p>La cadena  (" . $texto . ") No es un DNI</p>";
    } 
